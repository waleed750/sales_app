...
class DeviceInfoManager {
  ...
  final Completer<BaseDeviceInfo?> completerDeviceData = Completer<BaseDeviceInfo?>();
  
  Future<void> initPlatformState() async {
    BaseDeviceInfo? deviceData ;
    ...
    completerDeviceData.complete(deviceData);
  }
