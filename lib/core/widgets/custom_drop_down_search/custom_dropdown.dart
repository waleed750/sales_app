// ignore_for_file: unnecessary_library_name, library_private_types_in_public_api
...
final _defaultBorderRadius = BorderRadius.all(
  Radius.circular(5.r),
);

final Border _defaultErrorBorder =
